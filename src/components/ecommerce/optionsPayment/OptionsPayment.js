        ...
        <form>
          <div className="content-options">
            <input
              ...
              value="credit-card"
            />
            <label className="options" htmlFor="credit-card">Credit Card</label>
            <input
              type="radio"
              id="debit-card"
              name="payment-option"
              value="debit-card"
            />
            <label className="options" htmlFor="debit-card">Debit Card</label>
            <input
              type="radio"
              id="paypal"
              name="payment-option"
              value="paypal"
            />
            <label className="options" htmlFor="paypal">PayPal</label>
          </div>
        </form>
      )}
     </div>
